<template>
  <div class="part" v-bind:class="position">
    <img v-on:click="showPartInfo" v-bind:src="selectedPart.src" title="arm"/>
...
export default {
  ...
  updated() { // lifecycle component go to https://vuejs.org/v2/guide/instance.html#Lifecycle-Diagram
    this.emitSelectedPart();
  },
  computed: {
    selectedPart() {
